...
namespace CamSploit
{
    ...
    {
        [Option("target-host", Required = true, HelpText = "Text file with one single full host (IP:Port) per line",
            SetName = "a")]
        public string SingleHost { get; set; }

        [Option("list-host", Required = true, HelpText = "Single host in format IP:Port, example 192.168.0.1:80",
            SetName = "b")]
        ...
        [Option("exploit", Required = false,
            HelpText = "List of exploits separated by spaces, example CVE_2018_9995 Default_Password_CeNova",
            Separator = ',')]
